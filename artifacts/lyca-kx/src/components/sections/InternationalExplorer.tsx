...
export function InternationalExplorer() {
  ...
  return (
    <section className="py-24 px-4 md:px-6 bg-white dark:bg-background">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
          {filtered.map((country, idx) => (
            ...
            >
              ...
              {/* 2-letter country code — prominent, like original Lyca site */}
          ...
          {selected && (
            <>
              <div className="bg-[#0E1F5C] p-8 text-center text-white relative">
                ...
                <div className="text-3xl font-black text-white/30 mb-1">{selected.code}</div>
